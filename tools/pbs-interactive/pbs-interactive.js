(() => {
  const lessons = {
    ...
    family: {
      title:'家屬回應小幫手', intro:'家人的回應不需要很專業；簡短、穩定、能接住情緒就很有力量。',
      questions:[
        {q:'家人明顯煩躁地說：「我不要去了！」第一句較友善的回應是？', opts:['「有什麼好生氣的？」','「我知道你現在很不舒服。」','「你每次都這樣。」','「不准再說不要。」'], a:1, exp:'先同理不代表同意所有行為，而是先讓對方知道自己的狀態被看見。'},
